...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        if (Auth::guard('admin')->check()) {
            Log::info('Admin user: ' . Auth::guard('admin')->user()->email . ' dengan ID: ' . Auth::guard('admin')->user()->id);
            ...
            Log::warning('Admin tidak terautentikasi pada dashboard');
            // Jangan redirect ke login kalau sudah di halaman login
