    ...
    <form action="{{ route('admin.store-dosen') }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select @error('jabatan_fungsional') is-invalid @enderror" id="jabatan_fungsional" name="jabatan_fungsional">
                    <option value="">Pilih Jabatan</option>
                    <option value="Dosen Tetap" {{ old('jabatan_fungsional') == 'Dosen Tetap' ? 'selected' : '' }}>Dosen Tetap</option>
                    <option value="Dosen Tidak Tetap" {{ old('jabatan_fungsional') == 'Dosen Tidak Tetap' ? 'selected' : '' }}>Dosen Tidak Tetap</option>
