...
<div class="container">
    ...
    <a href="{{ url('/admin/managementuser_mahasiswa') }}" class="btn btn-sm mb-4" style="background: linear-gradient(to right, #004AAD, #5DE0E6); color: white;">
        <i class="fas fa-arrow-left"></i> Kembali
    </a>
    
    <form action="{{ url('/admin/store-mahasiswa') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select @error('program_studi') is-invalid @enderror" id="program_studi" name="program_studi">
                    <option selected>Teknik Informatika S1</option>
